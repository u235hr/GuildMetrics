...
interface ExpandedGoldCardProps {
  name: string;
  score: number;
  rank: number;
  avatar: string;
...
export default function ExpandedGoldCard({ name, score, rank, avatar }: ExpandedGoldCardProps) {
  return (
    <div className="expanded-card">
      <div className="outline-page">
        ...
        {/* 排名 */}
        <p className="ranking-number">
          {rank}<span className="ranking-word">st</span>
        </p>
      ...
      <div className="detail-page">
        ...
        <div className="grades-box">
          ...
          <p className="grades-box-label">SCORE</p>
          <p className="grades-box-num">{score}</p>
        </div>
      </div>
    </div>
  );
