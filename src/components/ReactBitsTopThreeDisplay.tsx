...
const ReactBitsTopThreeDisplay = memo(function ReactBitsTopThreeDisplay({ data }: ReactBitsTopThreeDisplayProps) {
  ...
  return (
    <div className="flex justify-center items-end gap-8 h-full">
      {/* ?? */}
      <div className="flex items-center justify-center bg-gradient-to-b from-gray-200 to-gray-400 text-black font-bold rounded-xl shadow-lg 
      ...
      {/* ?? */}
      <div className="flex items-center justify-center bg-gradient-to-b from-yellow-200 to-yellow-500 text-black font-bold rounded-xl shadow-xl 
                      w-36 h-52 md:w-40 md:h-64">
        <ReactBitsProfileCard
          item={sortedData[1]}
          index={1}
        />
      ...
      {/* ?? */}
      <div className="flex items-center justify-center bg-gradient-to-b from-orange-200 to-orange-600 text-black font-bold rounded-xl shadow-md 
